...
class UserOperations:
    ...
    def load_food_items(self):
            with open(r'C:\Users\anjaneyalu\Desktop\vs code py\final_project\FoodItems.json', 'r') as file:
                self.data= json.load(file)
    def write_food_items(self,data):
        with open(r'C:\Users\anjaneyalu\Desktop\vs code py\finalproject\orderHistory.json','w') as addfile:
    ...
    def placeOrder(self):
       ...
       if not self.selected_items:
            ...
            with open(r'C:\Users\anjaneyalu\Desktop\vs code py\finalproject.py\orderhistory.json','r') as file:
    ...
    def orderHistory(self):
        ...
        order_history=[]
        with open(r'C:\Users\anjaneyalu\Desktop\vs code py\finalproject\orderhistory.json','r') as file:
            data=json.load(file)
    ...
    def updateProfile(self):
        ...
        with open(r'C:\Users\anjaneyalu\Desktop\vs code py\finalproject\details.json', 'r') as file:
        ...
        for credit in credentials:
            if credit['name']==self.name:
                ...
                with open(r'C:\Users\anjaneyalu\Desktop\vs code py\finalproject\details.json','w') as w:
